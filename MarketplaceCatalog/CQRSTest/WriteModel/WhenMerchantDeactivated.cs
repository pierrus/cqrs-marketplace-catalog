...
{
    public class WhenMerchantDeactivated : Specification<Product, ProductCommandHandlers, DeactivateMerchantOnOffer>
    {
        private Guid _id;
        ...
        {
            return new DeactivateMerchantOnOffer(_id, _productId, _merchantId, 5);
        }

        [Then]
        public void Should_create_four_events()
        {
            //OfferMerchantDeactivated + ProductHidden + OfferHidden + OfferUnpublishedFromMerchant
